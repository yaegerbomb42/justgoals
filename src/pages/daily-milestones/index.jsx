          ...
          <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-heading-medium text-text-primary">
                    {viewMode === 'day' ? "Today's Milestones" : "Milestones"}
                  </h2>
                ...
                {safeFilteredMilestones.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-text-secondary mb-4">
                      Start by adding your first milestone for today
                    </p>
                    <Button
                      variant="primary"
                      onClick={() => setIsAddModalOpen(true)}
              ...
              <div className="bg-surface rounded-lg border border-border p-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-caption text-text-secondary">Ask Drift</span>
                  </button>
            ...
            <div className="hidden lg:block">
              <AIAssistantPanel
                ...
                selectedDate={selectedDate}
                milestones={safeFilteredMilestones}
                goals={safeGoals}
              />
            </div>
          </div>
